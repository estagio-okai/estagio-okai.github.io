...
const steps = [
  {
    ...
    body: "Use os menus SGP, Hubsoft ou IXC e escolha o canal (no Hubsoft: Suporte N1, Comercial ou Multi-Agente). O painel abre com o widget daquele token (canais em WIP mostram apenas um aviso).",
  },
  {
